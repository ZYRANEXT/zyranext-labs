...
const plans = [
  { name: 'Free', price: '$0 / month', plan: null, items: ['20 AI generations / month','Basic title, hook and post AI','Creator Profile','No Clip AI','No Overlay Builder'] },
  { name: 'Pro', price: '$19 / month', plan: 'pro' as const, items: ['Unlimited generations','Creator Memory','Cloud History','Clip AI','Basic Overlay Builder','30-day overlay URL'] },
  { name: 'Creator', price: '$49 / month', plan: 'creator' as const, items: ['Everything in Pro','Advanced Clip AI','Analytics','Growth Dashboard','Full Overlay Builder','90-day overlay URL'] },
  { name: 'Team', price: '$149 / month', plan: 'team' as const, items: ['Everything in Creator','Multi-user workspace','Shared creator profiles','Client management','Priority support'] },
];
